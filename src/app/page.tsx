          ...
          <div className="chat-layout">
            ...
            <aside className="knowledge-panel">
              <div className="panel-heading">
                <span>
                  <BookOpen size={17} /> Living knowledge
                </span>
                <span className="live-badge">LIVE</span>
              </div>
              <p className="panel-intro">
                Good conversations don’t disappear.
                <br />
              ...
              <div className="knowledge-stats">
                <div>
                  <strong>
                    {botEntries.length.toString().padStart(2, "0")}
                  </strong>
              ...
              {botEntries.length ? (
                ...
                <div className="empty-knowledge">
                  <span>✧</span>
                  <strong>A blank page. Endless potential.</strong>
                  <p>
                    As you chat, your wiki collects ideas
                    <br />
                    and context worth coming back to.
                  </p>
                </div>
              )}
              <button className="wiki-button" onClick={() => setView("wiki")}>
                Open knowledge wiki <ArrowUpRight size={14} />
              </button>
